...
/// scrollable app bar, see [SliverWhiteAppBar], which embeds an [WhiteAppBar] in a sliver
/// for use in a [CustomScrollView].
///
/// The WhiteAppBar displays the toolbar widgets, [leading], [title], and [actions],
...
///
/// If the [leading] widget is omitted, but the [WhiteAppBar] is in a [Scaffold] with
...
/// See also:
///
///  * [Scaffold], which displays the [WhiteAppBar] in its [Scaffold.appBar] slot.
///  * [SliverWhiteAppBar], which uses [WhiteAppBar] to provide a flexible app bar that
///    can be used in a [CustomScrollView].
///  * [TabBar], which is typically placed in the [bottom] slot of the [WhiteAppBar]
...
class WhiteAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// [WhiteAppBar] will imply an appropriate widget. For example, if the [WhiteAppBar] is
  /// in a [Scaffold] that also has a [Drawer], the [Scaffold] will fill this
  /// widget with an [IconButton] that opens the drawer (using [Icons.menu]). If
  /// there's no [Drawer] and the parent [Navigator] can go back, the [WhiteAppBar]
  ...
  ///
  /// A flexible space isn't actually flexible unless the [WhiteAppBar]'s container
  /// changes the [WhiteAppBar]'s size. A [SliverWhiteAppBar] in a [CustomScrollView]
  /// changes the [WhiteAppBar]'s height when scrolled.
  ///
  ...
  /// used by [SliverWhiteAppBar] to animate the opacity of the toolbar when the app
  /// bar is scrolled.
  ...
  @override
  _WhiteAppBarState createState() => new _WhiteAppBarState();
}
...
class _FloatingWhiteAppBar extends StatefulWidget {
  const _FloatingWhiteAppBar({Key key, this.child}) : super(key: key);

  final Widget child;

  @override
  _FloatingWhiteAppBarState createState() => new _FloatingWhiteAppBarState();
}

// A wrapper for the widget created by _SliverWhiteAppBarDelegate that starts and
/// stops the floating appbar's snap-into-view or snap-out-of-view animation.
class _FloatingWhiteAppBarState extends State<_FloatingWhiteAppBar> {
...
class _SliverWhiteAppBarDelegate extends SliverPersistentHeaderDelegate {
  _SliverWhiteAppBarDelegate({
  ...
  Widget build(
    ...
    return floating ? new _FloatingWhiteAppBar(child: appBar) : appBar;
  }

  @override
  bool shouldRebuild(covariant _SliverWhiteAppBarDelegate oldDelegate) {
...
/// the screen see [WhiteAppBar], which is used in the [Scaffold.appBar] slot.
///
/// The WhiteAppBar displays the toolbar widgets, [leading], [title], and
...
/// See also:
///
///  * [CustomScrollView], which integrates the [SliverWhiteAppBar] into its
///    scrolling.
///  * [WhiteAppBar], which is a fixed-height app bar for use in [Scaffold.appBar].
///  * [TabBar], which is typically placed in the [bottom] slot of the [WhiteAppBar]
///    if the screen has multiple pages arranged in tabs.
///  * [IconButton], which is used with [actions] to show buttons on the app bar.
///  * [PopupMenuButton], to show a popup menu on the app bar, via [actions].
...
///    can expand and collapse.
///  * <https://material.google.com/layout/structure.html#structure-toolbars>
class SliverWhiteAppBar extends StatefulWidget {
  /// Creates a material design app bar that can be placed in a [CustomScrollView].
  ///
  /// The arguments [forceElevated], [primary], [floating], [pinned], [snap]
  /// and [automaticallyImplyLeading] must not be null.
  const SliverWhiteAppBar({
    Key key,
    this.leading,
    this.automaticallyImplyLeading = true,
    this.title,
  ...
  /// A widget to display before the [title].
  ///
  /// If this is null and [automaticallyImplyLeading] is set to true, the [WhiteAppBar] will
  /// imply an appropriate widget. For example, if the [WhiteAppBar] is in a [Scaffold]
  ...
  /// [Navigator] can go back, the [WhiteAppBar] will use a [BackButton] that calls
  /// [Navigator.maybePop].
  final Widget leading;
  ...
  /// content is not scrolled under the [WhiteAppBar].
  ///
  /// Defaults to false, meaning that the [elevation] is only applied when the
  /// [WhiteAppBar] is being displayed over content that is scrolled under it.
  ///
  ...
  @override
  _SliverWhiteAppBarState createState() => new _SliverWhiteAppBarState();
}

// This class is only Stateful because it owns the TickerProvider used
// by the floating appbar snap animation (via FloatingHeaderSnapConfiguration).
class _SliverWhiteAppBarState extends State<SliverWhiteAppBar>
  ...
  @override
  void didUpdateWidget(SliverWhiteAppBar oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return new MediaQuery.removePadding(
      ...
      child: new SliverPersistentHeader(
        ...
        delegate: new _SliverWhiteAppBarDelegate(
